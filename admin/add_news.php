...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($error_message)) {
        $sql = "INSERT INTO news (title, content, club_id, author, image, published_date, featured) 
                VALUES ('$title', '$content', " . ($club_id ? $club_id : "NULL") . ", '$author', '$image_path', '$published_date', $featured)";
...
<head>
    ...
    <title>Add News Article - Premier University Club Admin</title>
   ...
   <?php include('admin_header.php');?>
    ...
    <main class="main-content" id="mainContent">
        ...
        <div class="content-section">
            <h2>News Article Information</h2>
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="author" name="author" required value="<?php echo isset($_POST['author']) ? htmlspecialchars($_POST['author']) : ($_SESSION['admin_name'] ?? ''); ?>">
                </div>
                ...
                <div class="action-buttons">
                    <button type="submit" class="btn btn-success">Add News Article</button>
                    <a href="news.php" class="btn">Cancel</a>
                </div>
            </form>
        </div>
    </main>
