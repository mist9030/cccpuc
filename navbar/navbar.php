<div class="fixed top-0 left-0 right-0 bg-black z-50 p-2 md:p-4">
    ...
    <li><a href="/PUC/homepage.php" class="text-white font-semibold hover:text-gray-300 text-lg md:text-base block py-3 md:py-0 border-b border-gray-700 md:border-0">Home</a></li>
    ...
    <li><a href="/PUC/profile.php" class="text-white font-semibold hover:text-gray-300 text-lg md:text-base block py-3 md:py-0">Profile</a></li>
                ...
                <li>
  <a href="/PUC/navbar/login.php" class="bg-blue-500 text-white font-medium py-2 px-6 rounded-md hover:bg-blue-600 transition-colors">Login</a>
</li>
<li>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    navLinks.forEach(link => {
        ...
        if (currentPath === linkPath || 
            (linkPath !== '/PUC/homepage.php' && currentPath.includes(linkPath))) {
